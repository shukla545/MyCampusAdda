    ...
    <section className="bg-white py-16">
      <Container>
        <div className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
            ...
            <div className="mt-7 grid gap-3">
              {strengths.map(({ title, text, icon: Icon }) => (
                <div key={title} className="flex gap-3 rounded-xl border border-slate-200 bg-slate-50 p-4">
                  <div className="grid h-10 w-10 shrink-0 place-items-center rounded-xl bg-white text-indigo-600 ring-1 ring-slate-200">
          ...
          <div className="rounded-2xl border border-slate-200 bg-slate-950 p-4 shadow-soft">
            <div className="rounded-xl bg-white p-4">
              ...
              <div className="mt-4 grid gap-3">
                <div className="ml-auto max-w-[82%] rounded-xl bg-indigo-600 px-4 py-3 text-sm font-semibold leading-6 text-white">
              ...
              <div className="mt-5 flex flex-wrap gap-2">
                {prompts.map((prompt) => (
                  <button
                    ...
                    className="rounded-full border border-slate-200 bg-white px-3 py-2 text-xs font-bold text-slate-600 transition hover:border-indigo-200 hover:bg-indigo-50 hover:text-indigo-700"
                  >
                    {prompt}
                  </button>
                ))}
