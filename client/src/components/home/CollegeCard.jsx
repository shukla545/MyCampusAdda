...
export default function CollegeCard() {
  return (
    <Link to="/college/thakur-college" className="block rounded-2xl border border-slate-200 bg-white p-6 shadow-sm transition hover:-translate-y-1 hover:border-brand/20 hover:shadow-soft">
